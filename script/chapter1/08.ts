 ...
 * @Description  :
 * @Author       : BigBigger
 * @Date         : 2021-08-17 15:26:51
 * @LastEditTime : 2021-08-17 16:50:14
...
export default (
  ...
  const controls = initControls(el, {
    rotationSpeed: { value: 0.02, params: [0, 0.5] },
    bouncingSpeed: { value: 0.03, params: [0, 0.5] },
  });
